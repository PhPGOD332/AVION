            ...
            <header class="header">
                <div class="up-block">
                    <div class="search-block">
                        <button class="search-btn nav-btn">
                            <svg class="nav-btn-icon search-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="index.php" class="logo-link">
                        <h1 class="logo">Avion</h1>
                    </a>
                    <div class="profile-block">
                        <button class="cart-btn nav-btn">
                            <svg class="nav-btn-icon cart-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="16" height="16" fill="white" style="mix-blend-mode:multiply"/>
                        ...
                        <button class="profile-btn nav-btn">
                            <svg class="nav-btn-icon profile-icon" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <rect width="16" height="16" fill="white" style="mix-blend-mode:multiply"/>
                ...
                <div class="bottom-block">
                    <ul class="menu-list">
                        <li class="menu-item">
                            <a href="#" class="menu-link">Plant pots</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">Geramics</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">Tables</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">Chairs</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">Crockery</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">Tableware</a>
                        </li>
                        <li class="menu-item">
                            <a href="#" class="menu-link">Cutlery</a>
                        </li>
                    </ul>
                </div>
            </header>
